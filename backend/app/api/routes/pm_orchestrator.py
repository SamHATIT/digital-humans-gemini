...
async def start_execution(
    ...
    # COMMENTED FOR TEST:     if 'pm' not in execution_data.selected_agents:
    # COMMENTED FOR TEST:         raise HTTPException(
    # COMMENTED FOR TEST:             status_code=status.HTTP_400_BAD_REQUEST,
    # COMMENTED FOR TEST:             detail="Product Manager (PM) agent is required and must be selected"
    # COMMENTED FOR TEST:         )
